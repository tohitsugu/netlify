...
* To scan driver's license, the app should call the `DLScannerHelper` class. This scanner scans the front and backside of the driver's license and handles the UI constraints of back and front screens. 
...
| iDriverLicenseListener | Interface of type IDriverLicenseListener|
...
| Params | Description |
| ----------- | ----------- |
| bidDriverLicense | Object of type BIDDriverLicense class. |
