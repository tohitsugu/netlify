---
slug: /blockid-android-sdk-141and142
id: blockid-android-sdk-141and142
---

# BlockID Android SDK 1.4.1 and 1.4.2

:::caution Note:
This document is compatible with Android SDK v1.4.1 and v1.4.2
:::
...
![image.png](https://cdn.document360.io/aeae7c88-d2f4-4a9c-bba9-c4f368260d78/Images/Documentation/image%2815%29.png){height="" width=""}

3. Click on the `+` icon.
4. Click `Choose import .JAR/.AAR`.
![image.png](https://cdn.document360.io/aeae7c88-d2f4-4a9c-bba9-c4f368260d78/Images/Documentation/image%2816%29.png){height="" width=""}


5. Locate the `BlockIDSDK_{version}-Release.aar` file and click **Apply**.
![image.png](https://cdn.document360.io/aeae7c88-d2f4-4a9c-bba9-c4f368260d78/Images/Documentation/image%2820%29.png){height="" width=""}


6. For module dependency, navigate to ***File > Project Structure > Dependencies app > declared dependencies tab > Module dependency***.
![image.png](https://cdn.document360.io/aeae7c88-d2f4-4a9c-bba9-c4f368260d78/Images/Documentation/image%2819%29.png){height="" width=""}


7. Select `BlockIDSDK_{version}-Release`.

![image.png](https://cdn.document360.io/aeae7c88-d2f4-4a9c-bba9-c4f368260d78/Images/Documentation/image%2821%29.png){height="" width=""}
...
<table>
  <tbody>
    ...
    <tr>
      <td>1</td>
      <td>com.google.code.gson:gson:2.8.5</td>
        <td>Gson</td>
    </tr>
    <tr>
      <td>2</td>
      <td>androidx.security:security-crypto:1.0.0-rc04</td>
      <td>Secure Shared preference</td>
    </tr>
    <tr>
      <td>3</td>
      <td>androidx.lifecycle:lifecycle-extensions:2.2.0</td>
      <td>lifecycle-extensions</td>
    </tr>
    <tr>
      <td>4</td>
      <td>androidx.lifecycle:lifecycle-runtime:2.2.0</td>
      <td>lifecycle-extensions</td>
    </tr>
     <tr>
      <td>5</td>
      <td>com.google.android.gms:play-services-vision:20.1.2</td>
      <td>QR Code scan</td>
    </tr>
      <tr>
      <td>6</td>
      <td>org.web3j:core:3.3.1-android</td>
      <td>wallet</td>
    </tr>
     <tr>
      <td>7</td>
      <td>implementation('org.bitcoinj:bitcoinj-core:0.15.4') {
        exclude group: 'com.google.protobuf', module: 'protobuf-java'
    }
</td>
      <td>generate mnemonics</td>
    </tr>
     <tr>
      <td>8</td>
      <td>androidx.biometric:biometric:1.0.1</td>
      <td>fingerprint and biometric</td>
    </tr>
     <tr>
      <td>9</td>
      <td>org.jetbrains:annotations:16.0.1</td>
      <td>fingerprint and biometric</td>
    </tr>
    <tr>
      <td>10</td>
      <td>commons-codec:commons-codec:1.10</td>
      <td>Base32 encode/decode</td>
    </tr>
    <tr>
      <td>11</td>
      <td>com.amitshekhar.android:android-networking:1.0.2</td>
      <td>Network Call</td>
    </tr>
    <tr>
      <td>12</td>
      <td>com.rmtheis:tess-two:9.0.0</td>
      <td>passport scan</td>
    </tr>
    <tr>
      <td>13</td>
      <td>implementation('org.jmrtd:jmrtd:0.5.13') {
    ...
    <tr>
      <td>14</td>
      <td>org.innovatrics.mrz:mrz-java:0.4</td>
      <td>passport scan</td>
    </tr>
     <tr>
      <td>15</td>
      <td>com.google.zxing:core:3.2.1</td>
      <td>scanning dl</td>
    </tr>
    <tr>
      <td>16</td>
      <td>androidx.multidex:multidex:2.0.1</td>
      <td>RFID Scan</td>
    </tr>
    <tr>
      <td>17</td>
      <td>net.sf.scuba:scuba-sc-android:0.0.20</td>
      <td>RFID Scan</td>
    </tr>
    <tr>
      <td>18</td>
      <td>com.madgag.spongycastle:prov:1.54.0.0</td>
      <td>RFID Scan</td>
    </tr>
    <tr>
      <td>19</td>
      <td>com.github.mhshams:jnbis:1.1.0</td>
      <td>RFID Scan</td>
    </tr>
    <tr>
      <td>20</td>
      <td>com.gemalto.jp2:jp2-android:1.0</td>
      <td>RFID Scan</td>
    </tr>
  </tbody>
</table>
...
```json
DLScannerHelper.getInstance().getDLScanIntent(this, K_DL_EXPIRY_GRACE_DAYS,iDriverLicenseListener);
```
Request Params Description: 
| Params | Description |
| ----------- | ----------- |
...
| iDriverLicenseListener | The interface of type IDriverLicenseListener|
...
| Params | Description |
| ----------- | ----------- |
| bidDriverLicense | The object of type BIDDriverLicense class. |
| signToken | The string value of signatureToken |
...
Add the [font](#https://drive.google.com/drive/folders/1gyrOcO2hvZDkJoSh1HIR3Uj1vloyfj7C) folder in the project app assets folder. 
```
...
<table>
  <tbody>
    ...
    <td>dataobject</td>
      <td>
     The object received after scanning (BIDDocumentData)
     </td>
   </tr>
   <tr>
    <td>documentType</td>
      <td>
     The object of `BIDDocumentProvider.BIDDocumentType`. There are three types of documentType
       <ol>
          <li>passport</li>
          <li>driverLicense</li>
          <li>nationalID</li>
   ...
   <tr>
    <td>signToken</td>
      <td>
       A string value of signature token received after scanning DL       
     </td>
   </tr>
   <tr>
...
* Scan the e-passport chip:
    ...
    * To scan the e-passport chip, use the following java method:
    ```json
     new PassportScannerHelper(this,K_PASSPORT_EXPIRY_GRACE_DAYS, passportResponseListener).startRFIDScanning();
    ```
...
* When e-passport chip scanning starts, you will get e-passport chip data in the `onNewIntent()` activity overridden method.
...
| Params | Description |
| ----------- | ----------- |
| mPassportScannerHelper | The object of a helper is created when RFID scanning start |
...
* To stop e-passport chip scanning, use passport scanner object with the following method:
...
There is one parameter for the scanning side of the NationalID. Based on this parameter, the scanner will act and scan the document accordingly. The front side of the document will be scanned using OCR, and the backside of the document will be used to scan OCR, MRZ, and QRCode.
* Add the following UI attribute to the XML:
```json
<LinearLayout
   android:id="@+id/layout_view"
   android:layout_width="wrap_content"
...
* Check the following order in which the NationalID can be scanned while using the methods:
    * `FIRST_FRONT_THEN_BACK`
    * `FIRST_BACK_THEN_FRONT`
* By default, the SDK will be set to `FIRST_BACK_THEN_FRONT` order. To set the order of NationalID scan, use the following method:
```json
new NationalIDScannerHelper(this, ScanningMode.SCAN_LIVE, NationalIDScanOrder.FIRST_BACK_THEN_FRONT,
       mBIDScannerView, mScannerOverlay, K_NATIONAL_ID_EXPIRY_GRACE_DAYS, nationalIDResponseListener).startNationalIDScanning();
```
Request Params Description: 
| Params | Description |
| ----------- | ----------- |
...
| mBIDScannerView | Custom UI object of class BIDScannerView |
| mScannerOverlay | Custom UI object of view ScannerOverlay |
| K_NATIONAL_ID_EXPIRY_GRACE_DAYS | Int value of NationalID expiry grace days |
| nationalIDResponseListener | The interface of type INationalIDResponseListener |

Response Params Description: 

| Params | Description |
| ----------- | ----------- |
| bidNationalID | The object of type `BIDNationalIDclass` |
| signToken | A string value of `signatureToken` |
| error | The object of type `ErrorManager.ErrorResponse` |

To stop scanning, use NationalID scanner object with the following method:
```json
mNationalIdScannerHelper.stopScanning();
```

**Check if the NationalID is enrolled**:
To check if NationalID is enrolled/registered with the BlockID, use the following SDK method:

```json
BlockIDSDK.getInstance().isNationalIDEnrolled();
```
**Save NationalID**:
To save a NationalID object, use the following SDK method:
...
<table>
  <tbody>
   ...
   <tr>
    <td>signToken</td>
      <td>
       A string value of signature token received after scanning NationalID       
     </td>
   </tr>
   <tr>
    <td>enrollListener</td>
...
**Unenroll NationalID**
Use the BlockIDSDK unregisterDocument method to unenroll a NationalID:
```json
BlockIDSDK.getInstance().unRegisterDocument(context,docType,unenrollListener);
```
Request Params Description: 
...
```json
BIDAuthProvider.getInstance().enrollDeviceAuth(this, title, desc,isPinFallBackRequired,biometricResponseListener);
```
...
| isPinFallBackRequired | Boolean value: True / false. True: The prompt with pin fallback, False: The prompt without pin fallback. |
...
```json
BIDAuthProvider.getInstance().unEnrollDeviceAuth(this, title, desc,isPinFallBackRequired,biometricResponseListener);
```
...
**To verify PIN**:
Use the following method to verify the PIN used to log in with an already enrolled PIN.
...
#### To call Redeem 
```json
BlockIDSDK.getInstance().verifyUserAccount(code, userID,  password, api, tag, community, BuildConfig.VERSION_NAME
, mLatitidude, mLongitude,  pushId, addScepAccountCallback);
```
...
```json
BlockIDSDK.getInstance().addNativeAccount(pushId, userID, password), bidOrigin, BuildConfig.VERSION_NAME, mLatitude, mLongitude
...
2.	On push, If the app is already not open (i.e., shut down or in the background), the user must be required to log in first.
...
```json
BlockIDSDK.getInstance().authenticateUser(userID,session,scopes,creds,origin,lat,lon,BuildConfig.VERSION_NAME,
...
|K_PP_NID_NOT_MATCH|417|Passport and NationalID data doesn't matched.|
...
| K_PP_ABOUT_TO_EXPIRE | 100001 | Passport will expire within 90 days, Would you like to continue enrollment? |
| K_PP_ALREADY_EXPIRED | 100002 | Expired passport. |
| K_INVALID_PP | 100003 | Invalid passport |
...
| K_PP_FACE_NOT_MATCH_WITH_PROFILE | 100008 | Your passport photo does not match with profile photo.|
