---
slug: /v1/blockid-workforce-mobile-application-user-guideold
id: Z1c4ca517-b3ce-483d-bb35-35a78f78747e
---
# BlockID Workforce Mobile Application - User Guide - old
...
2. From your BlockID Workforce mobile app:
    ![1.jpg](https://cdn.document360.io/aeae7c88-d2f4-4a9c-bba9-c4f368260d78/Images/Documentation/image%283%29.png){height="300" width=""}
3. Add the following URLs:
   * Enter the `root URL`, `root TAG`, `tenant URL`, and the `tenant TAG` assigned for your tenant’s BlockID Admin Console. For example, `1k-uat.1kosmos.net`, `1kosmos`, `<tenant>-uat.1kosmos.net`, and `<tenanttag>`.
